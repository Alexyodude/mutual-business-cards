...
body{background:radial-gradient(ellipse 1200px 800px at 80% -10%, rgba(8,145,178,0.06), transparent 60%),radial-gradient(ellipse 1000px 700px at 0% 110%, rgba(74,139,156,0.05), transparent 60%),var(--bg);background-attachment:fixed;position:relative}
...
.toc{margin:48px 0 64px;padding:24px;border:1px solid var(--line);border-radius:14px;background:var(--bg-2);display:grid;grid-template-columns:repeat(auto-fill, minmax(180px, 1fr));gap:8px}
...
.toc-link:hover{background:rgba(8,145,178,0.08);border-color:rgba(8,145,178,0.25)}
...
@keyframes flash{0%,40%{outline-color:var(--cyan);box-shadow:0 0 60px rgba(8,145,178,0.25)}100%{outline-color:transparent;box-shadow:0 0 0 transparent}}
...
.flip-side{position:absolute;inset:0;backface-visibility:hidden;-webkit-backface-visibility:hidden;border-radius:var(--radius);overflow:hidden;box-shadow:0 24px 60px -16px rgba(15,23,42,0.18),0 8px 28px -8px rgba(15,23,42,0.10),0 0 0 1px rgba(15,23,42,0.06)}
.flip-side img{display:block;width:100%;height:100%;object-fit:cover}
.flip-side.back{transform:rotateY(180deg)}
.flip-hint{position:absolute;left:18px;bottom:18px;z-index:5;font-family:'JetBrains Mono',monospace;font-size:11px;color:#22d3ee;letter-spacing:1.2px;padding:6px 10px;border-radius:999px;background:rgba(15,23,42,0.78);backdrop-filter:blur(6px);border:1px solid rgba(34,211,238,0.4);pointer-events:none;opacity:0.95}
.flip-stage.flipped .flip-hint{color:#e2e8f0;border-color:rgba(226,232,240,0.3)}
...
.thumb{aspect-ratio:1050/600;border-radius:8px;overflow:hidden;background:var(--bg-2);border:1px solid var(--line);position:relative}
.thumb img{display:block;width:100%;height:100%;object-fit:cover}
.thumb .label{position:absolute;left:10px;top:10px;font-family:'JetBrains Mono',monospace;font-size:10px;letter-spacing:1.2px;padding:4px 8px;border-radius:4px;background:rgba(15,23,42,0.78);color:#fff;backdrop-filter:blur(4px)}

.actions{display:flex;flex-wrap:wrap;gap:8px}
.btn{display:inline-flex;align-items:center;gap:8px;padding:10px 14px;border-radius:8px;border:1px solid var(--line);background:var(--bg);color:var(--fg);font-family:'JetBrains Mono',monospace;font-size:11px;letter-spacing:0.5px;text-decoration:none;cursor:pointer;transition:all 0.18s ease;font-weight:500}
.btn:hover{border-color:var(--cyan);color:var(--cyan);background:rgba(8,145,178,0.06)}
.btn svg{width:13px;height:13px;flex-shrink:0}
.share-btn,.fs-btn{border-color:rgba(8,145,178,0.4);color:var(--cyan);background:rgba(8,145,178,0.04)}
.share-btn:hover,.fs-btn:hover{background:rgba(8,145,178,0.10);border-color:var(--cyan)}

footer{margin-top:96px;padding-top:32px;border-top:1px solid var(--line);display:flex;align-items:center;justify-content:space-between;gap:16px;flex-wrap:wrap;font-family:'JetBrains Mono',monospace;font-size:11px;color:var(--fg-3);letter-spacing:0.6px}
...
/* ─── Toast ─── */
.toast{position:fixed;bottom:32px;left:50%;transform:translate(-50%, 120px);background:#0f172a;border:1px solid var(--cyan);color:#22d3ee;padding:11px 18px;border-radius:10px;font-family:'JetBrains Mono',monospace;font-size:12px;letter-spacing:1px;z-index:1100;transition:transform 0.3s cubic-bezier(0.5,0,0.2,1);pointer-events:none;box-shadow:0 16px 40px rgba(15,23,42,0.30),0 0 24px rgba(8,145,178,0.20)}
